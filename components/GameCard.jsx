        ...
        <View style={styles.jogo}>
            ...
            <View style={styles.linhaPrincipal}>
                <View style={styles.time}>
                    {teamLogos[game.sigla_casa] && (
                        <Image style={styles.bandeira} source={teamLogos[game.sigla_casa]} />
                    )}
                ...
                <View style={styles.time}>
                    ...
                    {teamLogos[game.sigla_fora] && (
                        <Image style={styles.bandeira} source={teamLogos[game.sigla_fora]} />
                    )}
                </View>
            </View>
